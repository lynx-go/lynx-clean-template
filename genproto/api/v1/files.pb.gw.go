...
var filter_FilesService_GetPresignedURL_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}

func request_FilesService_GetPresignedURL_0(ctx context.Context, marshaler runtime.Marshaler, client FilesServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetPresignedURLRequest
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_FilesService_GetPresignedURL_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_FilesService_GetPresignedURL_0(ctx context.Context, marshaler runtime.Marshaler, server FilesServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetPresignedURLRequest
		metadata runtime.ServerMetadata
	)
...
func RegisterFilesServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FilesServiceServer) error {
	mux.Handle(http.MethodGet, pattern_FilesService_GetPresignedURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_FilesService_GetPresignedURL_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_FilesService_GetPresignedURL_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterFilesServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FilesServiceClient) error {
	mux.Handle(http.MethodGet, pattern_FilesService_GetPresignedURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_FilesService_GetPresignedURL_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_FilesService_GetPresignedURL_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "files", "presigned-urls"}, ""))
)

var (
	forward_FilesService_GetPresignedURL_0 = runtime.ForwardResponseMessage
)
